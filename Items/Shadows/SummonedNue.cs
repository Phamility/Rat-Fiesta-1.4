...
namespace TenShadows.Items.Shadows
{
    ...
    public class SummonedNueItem : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Bird Silhouette");
            Tooltip.SetDefault("Summons a Nue to fight along side you!");
        ...
        public override void SetDefaults()
        {
            ...
            Item.UseSound = SoundID.Item76; // What sound should play when using the item

            // These below are needed for a minion weapon
            Item.noMelee = true; // this item doesn't do any melee damage
            Item.DamageType = DamageClass.Summon; // Makes the damage register as summon. If your item does not have any damage type, it becomes true damage (which means that damage scalars will not affect it). Be sure to have a damage type
            Item.buffType = ModContent.BuffType<SummonNueBuff>();
