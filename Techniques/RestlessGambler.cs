...
namespace TenShadows.Items.Techniques
{
    public class RestlessGambler : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            Tooltip.SetDefault("Upon use, have a 50% chance for a random buff or debuff lasting 41 seconds!\nIf the last roll was a buff, have a 65% chance for a random buff, and a 35% chance for a random debuff!\n41 second cooldown");
        }
        ...
        public override void OnConsumeMana(Player player, int manaConsumed)
        {
            ...
            int ROLLNUMBER;
            player.AddBuff(Item.buffType, 5 * 60);
        ...
        {
            if (player.HasBuff<GamblingDebuff>())
            {
